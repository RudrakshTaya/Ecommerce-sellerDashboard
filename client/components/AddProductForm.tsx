...
export default function AddProductForm({
  ...
  const validateForm = () => {
    ...
    if (!formData.deliveryDays || parseInt(formData.deliveryDays) <= 0)
      newErrors.deliveryDays = "Valid delivery days is required";
    ...
    if (parseInt(formData.stock) < parseInt(formData.lowStockThreshold)) {
      newErrors.lowStockThreshold =
        "Low stock threshold cannot be higher than current stock";
    }
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Upload multiple images (JPG, PNG, GIF). First image will be
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                {[
                  ...
                  <div
                    key={key}
                    className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg border hover:border-orange-300 transition-colors"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleInputChange("returnPolicy.period", e.target.value)
                      }
                      className="mt-1 border-gray-300 focus:border-green-500"
                      placeholder="30 days"
                    />
          ...
          <Card className="border-2 border-amber-100 shadow-lg">
            ...
            <CardContent className="p-6 space-y-4">
              {formData.faq.map((faq, index) => (
                <div
                  key={index}
                  className="p-4 border-2 border-amber-100 rounded-lg bg-amber-50/50"
                >
