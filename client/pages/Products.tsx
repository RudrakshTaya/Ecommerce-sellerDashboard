      ...
      <div className="aspect-square relative bg-gray-100">
        ...
        <div className="absolute top-2 left-2 flex flex-wrap gap-1 max-w-[70%]">
          {product.badges.map((badge, index) => (
            <Badge key={index} variant="default" className="bg-blue-600 text-xs">
              {badge}
            </Badge>
          ))}
          {product.isNew && (
          ...
          {product.isDIY && (
            <Badge variant="outline" className="text-xs bg-orange-100">DIY</Badge>
          )}
          {product.isInstagramPick && (
            <Badge variant="outline" className="text-xs bg-pink-100">📷 Insta Pick</Badge>
          )}
        </div>
        {isLowStock && (
      ...
      <CardContent className="p-3 sm:p-4">
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <div className="flex items-center justify-between text-sm text-gray-600">
            <span className={isLowStock ? 'text-red-600 font-medium' : ''}>Stock: {product.stock}</span>
          ...
          <div className="flex items-center justify-between text-xs text-gray-500">
            {product.warranty && (
              <span>🛡️ {product.warranty.period}</span>
            )}
          ...
          {product.careInstructions && product.careInstructions.length > 0 && (
            <div className="text-xs text-gray-500">
              ...
              {product.careInstructions.length > 1 && <span> +{product.careInstructions.length - 1} more</span>}
            </div>
          )}
          ...
          <div className="flex gap-1.5 sm:gap-2 mt-2 sm:mt-3">
            ...
            <Button size="sm" variant="outline" onClick={() => onEdit(product)} className="h-8 sm:h-9 px-2 sm:px-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-200 pb-5">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Manage your product catalog and inventory with warranty, care instructions, and more
            </p>
          </div>
          <Button 
          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">With Warranty</p>
                  <p className="text-2xl font-bold text-gray-900">
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="mt-1 text-sm text-gray-500 px-4">
              {searchTerm || selectedCategory ? 'Try adjusting your filters' : 'Get started by adding your first product with comprehensive details'}
            </p>
