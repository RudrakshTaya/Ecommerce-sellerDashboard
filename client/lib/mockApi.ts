import { Product, Order, OrderItem, SellerStats, ProductsResponse, OrdersResponse, StatsResponse } from '@shared/api';
  ...
  return [
    {
      ...
      price: 2499,
      originalPrice: 2999,
      description: "Beautiful handcrafted wooden jewelry box with intricate carvings and velvet lining. Perfect for storing your precious jewelry and accessories.",
      ...
      careInstructions: ["Clean with dry cloth", "Avoid exposure to moisture", "Use wood polish monthly"],
      dimensions: {
        length: 25,
        width: 15,
        height: 10,
      ...
      seoDescription: "Beautiful handcrafted wooden jewelry box with intricate carvings. Made from sustainable teak wood with velvet lining.",
      faq: [
        {
    ...
    },
    {
      ...
      price: 899,
      originalPrice: 1199,
      description: "Complete DIY kit for creating beautiful macrame wall hangings. Includes all materials, tools, and step-by-step guide for beginners.",
      image: "/placeholder.svg",
      ...
      seoDescription: "Complete DIY macrame kit with all materials and instructions. Perfect for beginners and craft enthusiasts.",
      faq: [
        {
          question: "Is this suitable for beginners?",
          answer: "Yes, the kit includes detailed step-by-step instructions perfect for beginners."
        },
        {
    ...
    },
    {
      ...
      price: 1599,
      originalPrice: 1899,
      description: "Traditional blue pottery ceramic tea set with intricate patterns. Perfect for tea lovers and collectors of fine ceramics.",
      image: "/placeholder.svg",
      ...
      returnPolicy: {
        returnable: true,
        period: "30 days",
        conditions: ["Item must be undamaged", "Original packaging required", "No chips or cracks"]
      },
      careInstructions: ["Hand wash only", "Avoid sudden temperature changes", "Handle with care"],
      dimensions: {
        length: 35,
        width: 25,
        height: 15,
      ...
      seoDescription: "Authentic blue pottery ceramic tea set with traditional patterns. Handmade in Rajasthan by skilled artisans.",
      faq: [
        {
          question: "Is this microwave safe?",
          answer: "No, this is traditional pottery and should not be used in microwave."
        },
        {
          question: "How many pieces are included?",
          answer: "The set includes 1 teapot, 4 cups, 4 saucers, and 1 serving tray."
        }
      ]
    },
    {
      ...
      price: 2299,
      originalPrice: 2799,
      description: "Soft and cozy handwoven cotton throw with traditional patterns. Perfect for any room and all seasons.",
      image: "/placeholder.svg",
      images: ["/placeholder.svg", "/placeholder.svg"],
      category: "Textiles",
      ...
      returnPolicy: {
        returnable: true,
        period: "30 days",
        conditions: ["Item must be unused", "Original packaging required", "Tags attached"]
      },
      ...
      sustainabilityInfo: "Made from 100% organic cotton using eco-friendly dyes",
      origin: "Tamil Nadu, India",
      inStock: true,
      lowStockThreshold: 5,
      seoTitle: "Handwoven Organic Cotton Throw - Eco-Friendly Home Decor",
      seoDescription: "Soft handwoven cotton throw made from organic cotton. Perfect for sustainable home decor.",
      faq: [
        {
          question: "Is this made from organic cotton?",
          answer: "Yes, this throw is made from 100% GOTS certified organic cotton."
        },
        {
          question: "What sizes are available?",
          answer: "Available in Medium (150x200cm) and Large (180x220cm) sizes."
        }
      ]
    }
  ];
...
export const mockApi = {
  ...
  // Add/Update product
  saveProduct: async (product: Omit<Product, 'id'> | Product): Promise<Product> => {
  ...
  getOrderDetails: async (orderId: string, sellerId: string): Promise<Order> => {
