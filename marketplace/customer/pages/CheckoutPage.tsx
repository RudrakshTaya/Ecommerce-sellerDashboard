      ...
      <div className="min-h-screen bg-gradient-to-br from-craft-50 via-earth-50 to-warm-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center py-16">
            ...
            <p className="text-earth-600 mb-8">Add some items to your cart before checkout.</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-warm-100 p-6">
              <div className="flex items-center space-x-3 mb-6">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                  step >= 1 ? 'bg-craft-600 text-white' : 'bg-warm-200 text-warm-600'
                }`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-earth-900 mb-2">ZIP Code</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-earth-900 mb-2">Country</label>
                  <select
            ...
            {step >= 2 && (
              <div className="bg-white rounded-xl shadow-sm border border-warm-100 p-6">
                <div className="flex items-center space-x-3 mb-6">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${
                    step >= 2 ? 'bg-craft-600 text-white' : 'bg-warm-200 text-warm-600'
                  }`}>
                    <CreditCard className="w-5 h-5" />
                  </div>
                  <h2 className="text-xl font-semibold text-earth-900">Payment Information</h2>
                </div>

                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-earth-900 mb-2">Card Number</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-earth-900 mb-2">Expiry Date</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-sm font-medium text-earth-900 mb-2">CVV</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-earth-900 mb-2">Name on Card</label>
                    <input
                      type="text"
                ...
                {items.map((item) => (
                  <div key={item.productId} className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-medium text-earth-900 text-sm">{item.product.name}</h3>
