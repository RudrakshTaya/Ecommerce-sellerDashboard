...
import { Star, MapPin, Phone, Mail, Globe, Clock, Award, ShoppingBag, Grid, List, ChevronDown, Filter } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-craft-50 via-earth-50 to-warm-50">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center py-16">
            <h1 className="text-3xl font-bold text-earth-900 mb-4">Seller Not Found</h1>
            <p className="text-earth-600 mb-8">{error || 'The seller you are looking for does not exist.'}</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-craft-50 via-earth-50 to-warm-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="text-sm text-earth-600 mb-6">
          ...
          <Link to="/sellers" className="hover:text-craft-600">Sellers</Link>
          <span className="mx-2">/</span>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-warm-100 p-8 mb-8">
          <div className="flex flex-col lg:flex-row lg:items-start lg:space-x-8">
            <div className="flex items-start space-x-6 mb-6 lg:mb-0">
              ...
              />
              <div>
                <h1 className="text-3xl font-bold text-earth-900 mb-2">{seller.storeName}</h1>
                ...
                <div className="flex items-center space-x-6 text-sm text-earth-600">
                  <div className="flex items-center">
                    ...
                    <span className="ml-1">({seller.reviewCount || 0} reviews)</span>
                  </div>
                  <div className="flex items-center">
                  ...
                  {seller.businessAddress?.city && (
                    <div className="flex items-center">
                      ...
                      <span>{seller.businessAddress.city}, {seller.businessAddress.state}</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="lg:ml-auto flex-shrink-0">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="bg-craft-50 rounded-lg p-4">
                  <div className="text-2xl font-bold text-craft-600">{seller.totalSales || 0}</div>
                  <div className="text-sm text-earth-600">Total Sales</div>
                </div>
                <div className="bg-sage-50 rounded-lg p-4">
                  <div className="text-2xl font-bold text-sage-600">
                    {seller.memberSince ? new Date(seller.memberSince).getFullYear() : 'N/A'}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              {seller.website && (
                <div className="flex items-center text-earth-600">
                  ...
                  <a href={seller.website} target="_blank" rel="noopener noreferrer" className="hover:text-craft-600">
                    Visit Website
                  </a>
                </div>
              )}
        ...
        {activeTab === 'about' && (
          <div className="bg-white rounded-xl shadow-sm border border-warm-100 p-8">
            <h2 className="text-2xl font-bold text-earth-900 mb-6">About {seller.storeName}</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-earth-900 mb-4">Store Information</h3>
                  ...
                  {seller.policies && (
                    <div>
                      ...
                      <ul className="list-disc list-inside mt-2 space-y-1">
                        <li>Returns: {seller.policies.returns || 'Contact seller'}</li>
                        <li>Shipping: {seller.policies.shipping || 'Contact seller'}</li>
                        <li>Exchanges: {seller.policies.exchanges || 'Contact seller'}</li>
                      </ul>
                    </div>
                  )}
                </div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-earth-900 mb-4">Business Details</h3>
                <div className="space-y-3 text-earth-600">
                  {seller.businessAddress && (
                    <div>
                      <strong>Location:</strong>
                      <div className="mt-1">
                        {seller.businessAddress.street && <div>{seller.businessAddress.street}</div>}
                        <div>
                  ...
                  {seller.memberSince && (
                    <div>
                      <strong>Member Since:</strong> {new Date(seller.memberSince).toLocaleDateString()}
                    </div>
                  )}
        ...
        {activeTab === 'reviews' && (
          <div className="bg-white rounded-xl shadow-sm border border-warm-100 p-8">
            <h2 className="text-2xl font-bold text-earth-900 mb-6">Customer Reviews</h2>
