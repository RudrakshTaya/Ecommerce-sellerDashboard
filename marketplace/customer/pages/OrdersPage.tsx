    ...
    <div className="min-h-screen bg-gradient-to-br from-craft-50 via-earth-50 to-warm-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-earth-600">Track and manage your handmade craft orders</p>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl p-8 shadow-sm border border-warm-100 text-center">
            ...
            <h3 className="text-xl font-semibold text-earth-900 mb-2">Error Loading Orders</h3>
            <p className="text-earth-600">Failed to load your orders. Please try again.</p>
          </div>
          ...
          <div className="space-y-6">
            {filteredOrders.map((order) => (
              <div key={order._id} className="bg-white rounded-xl shadow-sm border border-warm-100 overflow-hidden">
                {/* Order Header */}
                <div className="p-6 border-b border-warm-200">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="text-right">
                      <p className="text-2xl font-bold text-craft-600">${order.total.toFixed(2)}</p>
                      <p className="text-sm text-earth-600">{order.items.length} items</p>
                    </div>
                  </div>
                </div>
