            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-2">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="w-20 h-20 bg-warm-200 rounded-lg animate-pulse"
                  />
                ))}
              </div>
            </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-craft-50 via-earth-50 to-warm-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm text-earth-600 mb-8">
          ...
          <span>/</span>
          <Link to="/products" className="hover:text-craft-600">
            Products
          </Link>
          <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {/* Quantity Selector */}
              <div className="flex items-center space-x-4">
                <label className="text-sm font-medium text-earth-900">
                  Quantity:
                </label>
